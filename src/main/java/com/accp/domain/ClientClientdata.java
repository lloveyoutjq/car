...
public class ClientClientdata {
    ...
    public String getRegosterphone() {
        return regosterphone;
    }

    public void setRegosterphone(String regosterphone) {
        this.regosterphone = regosterphone;
    }
